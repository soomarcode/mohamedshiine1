    ...
    useEffect(() => {
        const loadInitialData = async () => {
            ...
            const { data: certData } = await supabase
                ...
                .eq('course_id', course.id)
                .single();
            if (certData) setCertificateTemplate(certData);
    ...
    return (
        <>
                                ...
                                <div className="curriculum-view">
                                    <div className="curriculum-layout-split" style={{ display: 'flex', gap: '30px' }}>
                                        <section className="full-curriculum-list" style={{ flex: '1' }}>
                                            ...
                                            {!isPreviewMode && calculateProgress() === 100 && certificateTemplate && (
                                                <button
                                                    className="btn-apply-cert"
            ...
            <CertificateGenerator
                ...
                course={course}
                user={user}
                templateUrl={certificateTemplate?.template_url}
                signatureUrl={certificateTemplate?.signature_url}
            />
        </>
    );
};
